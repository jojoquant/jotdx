...
stock_ip_append = [
    {'ip': '120.79.60.82', 'port': 7709},
    {'ip': '8.129.13.54', 'port': 7709},
    {'ip': '120.24.149.49', 'port': 7709},
    {'ip': '47.113.94.204', 'port': 7709},
    {'ip': '8.129.174.169', 'port': 7709},
    {'ip': '47.113.123.248', 'port': 7709},
    {'ip': '47.103.48.45', 'port': 7709},
    {'ip': '47.100.236.28', 'port': 7709},
    {'ip': '101.133.214.242', 'port': 7709},
    {'ip': '47.116.21.80', 'port': 7709},
    {'ip': '47.116.105.28', 'port': 7709},
    {'ip': '47.116.10.29', 'port': 7709},
    {'ip': '39.98.234.173', 'port': 7709},
    {'ip': '39.98.198.249', 'port': 7709},
    {'ip': '39.100.68.59', 'port': 7709},
    {'ip': '106.53.96.220', 'port': 7709},
    {'ip': '106.53.99.72', 'port': 7709},
    {'ip': '106.55.12.89', 'port': 7709},
    {'ip': '47.103.86.229', 'port': 7709, 'name': '上海双线主站2'},
    # {'ip': '47.103.88.146', 'port': 7709, 'name': '上海双线主站3'},
    # {'ip': '47.112.129.66', 'port': 7709, 'name': '深圳双线主站2'},
]

stock_ip += stock_ip_append
...
future_ip_append = [
    {'ip': '47.102.108.214', 'port': 7727, 'name': '扩展市场上海双线2'},
    {'ip': '119.23.127.172', 'port': 7727, 'name': '扩展市场新加双线0'},
]

future_ip += future_ip_append
...
if __name__ == '__main__':
    ...
    # sync_cost_time = datetime.datetime.now() - start_time
    #
    # start_time = datetime.datetime.now()
    # ipp = select_best_ip_async('stock')
    # async_cost_time = datetime.datetime.now() - start_time
    # print(f"sync_cost_time:{sync_cost_time}, async_cost_time:{async_cost_time}")
    ...
    start_time = datetime.datetime.now()
    ipp = select_best_ip_async('future')
    async_cost_time = datetime.datetime.now() - start_time
    print(f"sync_cost_time:{sync_cost_time}, async_cost_time:{async_cost_time}")
